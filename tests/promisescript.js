...
global.addEventListener('unhandledrejection', function(err) {
  err.preventDefault();
    ...
    describe(test.name, function() {
      ...
      describe('single URL', function() {
        it('should return a promise', function() {
          ...
          return promise.catch(promisescript.LoadError, function() {});
        });
        ...
        it('should the same promise for the same URL', function() {
          ...
          return Bluebird.all([
            promise1,
            promise2
          ]).catch(promisescript.LoadError, function() {});
        });
  ...
  describe('Clearing cache', function() {
    it('should remove all items from cache when no arguments are passed', function() {
      ...
      promise2 = promise1.then(function() {
        return promisescript(successURL);
      });
